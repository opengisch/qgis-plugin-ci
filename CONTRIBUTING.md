...
- formatting and static analysis: [ruff](https://docs.astral.sh/ruff/formatter/) is used to automatically format the code without debate and to catch some dizziness and keep the source code healthy.
